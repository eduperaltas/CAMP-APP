...
import 'mensajes_borrador,detalle.dart';
import 'mensajes_profile_nueva.dart';

class Borradores extends StatefulWidget{
  @override
  State createState() {
    return _Borradores();
  }
}
class _Borradores extends State<Borradores>{
  @override
  String _Msjbuscar="";
  String _Seccion='borrador';
  Widget correo(Mensaje msj){
    return Column(
      children: [
        GestureDetector(
          onTap: (){
            Navigator.push(context, PageTransition(child: ContinuaMensaje(msj: msj,), type: PageTransitionType.rightToLeft));
          },
          child: Container(
