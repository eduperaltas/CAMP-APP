...
class SociasCampScreenView extends StatefulWidget with NavigationStates{
  @override
  State createState() {
    return _SociasCampScreenView();
  }
}
class _SociasCampScreenView extends State<SociasCampScreenView>{
  @override
