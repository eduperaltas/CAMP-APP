...
class NuevoMensaje extends StatefulWidget{
  ...
  NuevoMensaje({this.msj});
}
class _NuevoMensaje extends State<NuevoMensaje>{

  String _name = "";
  String _busca = 'Buscar...';
  String _mensaje ;
  Contact _contacto=new Contact(uid: '', name: '', foto: '');
  @override
        ...
        leading: IconButton(
          ...
          onPressed:(){
            if(_contacto!=null)
              showDialog(
                context: context,
                builder: (context) => BorradorDialog(new Mensaje(idremitente: uid, iddestinatario: _contacto.uid,fotodest: _contacto.foto,
            ...
            GestureDetector(
              onTap: (){
                if(_mensaje!=null && _contacto.uid!=null){
                  ...
                  FirestoreAPI().nuevoMensaje(new Mensaje(idremitente: uid, iddestinatario: _contacto.uid,fotodest: _contacto.foto,
                     Nremitente: name, Ndestinatario: _contacto.name, mensaje: _mensaje, fotoremit: imageUrl),false);
