...
class BuzonDeEntrada extends StatefulWidget{
  @override
  State createState() {
    return _BuzonDeEntrada();
  }
}
class _BuzonDeEntrada extends State<BuzonDeEntrada>{
  @override
  String _Msjbuscar="";
  String _Seccion='entrada';
  Widget correo(Mensaje msj){
    return Column(
      children: [
        GestureDetector(
          onTap: (){
            FirestoreAPI(TipMensaje: _Seccion).vistoMensaje(msj);
            Navigator.push(context, PageTransition(child: Mensajes_buzon_detail(msj: msj,desdeSeccion: _Seccion,), type: PageTransitionType.rightToLeft));
          },
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Container(width: 3,height: MediaQuery.of(context).size.height*0.1,color: msj.leido?Color(0XffC4C3C3):Color(0Xff2056a1),),
                ),
                CircleAvatar(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: NetworkImage(msj.fotoremit)
                      ),
                    ),
                  ),
