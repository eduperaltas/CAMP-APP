...
class QuienesSomosScreenView extends StatefulWidget with NavigationStates{
  @override
  State createState() {
    return _QuienesSomosScreenView();
  }
}
class _QuienesSomosScreenView extends State<QuienesSomosScreenView>{
  @override
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage("assets/images/shutterstock_1207066645.jpg")
                ),
              ),
            ),
            SizedBox(
