...
class MisionVisionScreenView extends StatefulWidget with NavigationStates{
  @override
  State createState() {
    return _MisionVisionScreenView();
  }
}
class _MisionVisionScreenView extends State<MisionVisionScreenView>{
  @override
